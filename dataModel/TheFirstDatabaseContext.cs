...
public partial class TheFirstDatabaseContext : DbContext
{
    public TheFirstDatabaseContext()
    {
    }

    public TheFirstDatabaseContext(DbContextOptions<TheFirstDatabaseContext> options)
        : base(options)
    {
    }
