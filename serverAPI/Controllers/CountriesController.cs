...
namespace serverAPI.Controllers
{
    ...
    public class CountriesController : ControllerBase
    {
        ...
        public CountriesController(TheFirstDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<DTO.CountryPopulation>> GetCountryPopulation(int id)
        {
            ...
            long citiesPop = _context.Cities.Where(x => x.Id == id).Select(x => x.Population).Sum();

            DTO.CountryPopulation countryPopulation = new()
            {
                Id = country.Id,
                Name = country.Name,
